...
This project is an end-to-end **UI automation testing framework** developed for the **Automation Exercise** (https://www.automationexercise.com/) website using **Selenium WebDriver with C#**.  
